...
class Player{
	...
	private int mapMX, mapMY; // the map coordinates of the mouse
	private int tx,ty,tb; // the previous mouse location
	private int mapTX, mapTY; // the previous mouse location on the map
	private GUI gui;
