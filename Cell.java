...
public class Cell{
	...
	public void remove( Unit other ){this.set.remove( other );}
	public void add( Unit other ){this.set.add( other );}
	...
	public LinkedList<Unit> getUnitList(){return set;}
	public Unit getFirstUnit(){return set.peek();}
