public class StarTroop extends Unit{
	...
	public void initBody(){
 		double[][] Xcords = {
 		{-8.0, -27.0, 0.0, 3.0, 6.0, 27.0, 11.0, 25.0, 12.0, 2.0, -12.0, -25.0, -7.0},{-1.0, -7.0, -1.0, 7.0, 7.0}};
		double[][] Ycords = {{-2.0, 9.0, -3.0, 14.0, -4.0, 8.0, -4.0, -17.0, -25.0, -10.0, -26.0, -21.0, -8.0 },{-11.0, -28.0, -40.0, -43.0, -31.0}
		};
