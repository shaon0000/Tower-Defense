...
class MyMenu{
	private int[] pos ;
	private int c, w, h, r ; // the number of columns, width, height, and rows in this menu
	private Image pressImg ; // the image that goes on top of buttons if they are pressed
	private int n, nextX, nextY, currentCellX, currentCellY, TB ; // number of buttons currently in the menu;
	...
	public void setVisible( boolean n ){visible=n;}
	...
	public void autoDeclick(String name,boolean auto){buttonSet.get(name).auto = auto;}
	...
	public myButton getActiveButton() {return currentButton;}
